...
public class Main {
	...
	public static void main(String[] args) {
		...
		String miner = "MINER_USER_ID";          
		String minerPassword = "MINER_USER_PASSWORD";
		String firstUser = "FIRST_USER_ID";
		String firstPassword = "FIRST_USER_PASSWORD";
		String secondUser = "SECOND_USER_ID";
		String secondPassword = "SECOND_USER_PASSWORD";
