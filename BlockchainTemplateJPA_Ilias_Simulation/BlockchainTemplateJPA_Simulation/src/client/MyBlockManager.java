...
public class MyBlockManager extends BlockManager {
	...
	// wird genutzt in MyBlockManager "doSomethingWithTheBlock" zur Überprüfung
...
//		System.out.println("doSomethingWithTheBlock:: theBlock = " + theBlock);
		...
		System.out.println("doSomethingWithTheBlock :: text (von Bytearray zurückkonvertiertes Datum) = " + text);

		// nur zur Demonstration: Textersetzung, z.B. für internationale Ausgabe
